...
public class LeafCategoriesAdapterDelegate extends CategoriesAdapterDelegate {
    ...
    public LeafCategoriesAdapterDelegate(final Context context, final LayoutInflater inflater,
    ...
    protected RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent) {
        ...
        return new LeafCategoryViewHolder(
            mInflater.inflate(R.layout.cell_leaf_category, parent, false), mClickListener);
    }

    @Override
    protected void onBindViewHolderGeneric(@NonNull final List<Category> items, final int position,
                                           @NonNull final CategoriesViewHolder holder,
